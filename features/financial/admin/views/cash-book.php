...
<div class="card page-card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="cashBookTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle text-center" style="width: 50px;">Aksi</th>
                    </tr>
                    <tr>
...
<style>
    /* Optional: Add some subtle striping or hover effects */
    .table-hover tbody tr:hover {
        background-color: #f8f9fa;
    }
    /* Make zero values lighter */
    td.text-right:contains('-') {
        color: #ccc;
    }
</style>
