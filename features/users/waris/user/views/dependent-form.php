    ...
    <form method="post">
        ...
        <div class="grid-2">
            <div class="form-group" style="grid-column: 1 / -1;">
                ...
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($dependent['name'] ?? ''); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($dependent['email'] ?? ''); ?>">
            </div>

            <div class="form-group">
                <label for="phone_number">Phone Number</label>
                <input type="text" id="phone_number" name="phone_number" value="<?php echo htmlspecialchars($dependent['phone_number'] ?? ''); ?>">
            </div>

            <div class="form-group" style="grid-column: 1 / -1;">
                <label for="address">Address</label>
                <textarea id="address" name="address" rows="3"><?php echo htmlspecialchars($dependent['address'] ?? ''); ?></textarea>
            </div>
        </div>
